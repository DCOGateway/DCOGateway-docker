...
If (-not ($BTCPAYGEN_DOCKER_IMAGE)) { $BTCPAYGEN_DOCKER_IMAGE = "dcogateway/docker-compose-generator" }

If ($BTCPAYGEN_DOCKER_IMAGE -eq "dcogateway/docker-compose-generator:local"){
